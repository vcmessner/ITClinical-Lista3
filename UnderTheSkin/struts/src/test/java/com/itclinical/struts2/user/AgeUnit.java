...
public class AgeUnit {
    ...
    public void calculateAgeTest() throws ParseException{       
        String todayString =  StringDateGenHelper.createDateFromNow(ProbabilityConstants.RANDOM_AGE_LOWERBOUND);
    ...
    private void calculateAgeTestEdgeCases(LocalDate today){
        ...
        int difference = random.nextInt(ProbabilityConstants.RANDOM_AGE_LOWERBOUND);
